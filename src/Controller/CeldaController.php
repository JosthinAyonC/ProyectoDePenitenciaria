...
class CeldaController extends AbstractController
{
    ...
    #[Route('/{idCelda}', name: 'app_celda_show', methods: ['GET'])]
    ...
    #[Route('/{idCelda}/edit', name: 'app_celda_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{idCelda}', name: 'app_celda_delete', methods: ['POST'])]
    public function delete(Request $request, Celda $celda, CeldaRepository $celdaRepository): Response
    {
        if ($this->isCsrfTokenValid('delete'.$celda->getIdCelda(), $request->request->get('_token'))) {
